  ...
  <div class="card mt-4 mb-4">
    ...
    <div class="card-body">
      ...
      <div class="d-flex justify-content-start mb-4">
        ...
        <a href="page/pelanggan/laporanpelanggan.php" target="_blank" type="button" class="btn btn-sm btn-info mr-3"><i class="fas fa-download fa-sm text-white"></i> Download PDF</a>
      </div>
      <!-- END: Button -->
